...
**Por exemplo, no inicio do programa são requisitados valores numéricos. Caso seja passado valores impossiveis de converter em decimal, o programa simplesmente pede novos valores até que seja apresentado um valor válido.** 

**O mesmo foi feito ao remover veículos. No momento em que é solicitado o tempo em que o veículo permaneceu ali caso seja impossivel converter o valor apresentado para o tipo TimeSpan, o programa pede novamente o valor.** 

**Ao Remover um veículo do estacionamento é necessario passar a quantidade de horas que o mesmo permaneceu ali. Implementei isso pedindo um valor em horas e minutos, por exemplo "01:30", que internamente é convertido para decimal apenas para calcular o valor a ser cobrado. fiz desta forma para que seja mais natural o uso do programa.** 

As outras funcionalidades do programa permanecem as mesmas.
